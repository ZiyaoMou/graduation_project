...
class ServerlessSimulator:
    ...
    def req(self,time,i):
        ...
        """
        return self.arrival_process.generate_trace(time,i)
...
req(
        ...
        i=0
        if(self.arrival_process.time):   
            next_arrival = t + self.req(self.arrival_process.time,i)
            i+=1
        else:next_arrival = t + self.req(time=None,i=None)
